    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latln) {
                ...
                lon = Double.parseDouble(sLng);
                Toast.makeText(MainActivity.this, "Latitude is: "+lat+", Longtitude is: "+lon, Toast.LENGTH_LONG).show();
            }
        });

       // lugares.add(new Lugar("Aqui", lat, lon));
